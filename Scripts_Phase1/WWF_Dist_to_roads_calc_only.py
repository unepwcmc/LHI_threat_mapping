...
#Make a list of tuples with FClass and correspondng attribute value
                    ...
                    #TO CALCULATE ACCESSIBILITY METRICS
                        #1. ADD 5 NEW FIELDS FOR 2 GROUPS OF ROADS: MAJOR_ROADS (HIGHWAY, UNSPECIFIED, PRIM,SEC,TERT), MINOR_ROADS (TRAIL,LOCAL/URBAN,PRIVATE) AND 3 GROUPS OF THREAT: HIGH, MEDIUM AND LOW
                        #2. POPULATE 2 GROUPS OF ROADS WITH MINIMUM DISTANCE VALUES FROM RESPECTIVE ROADS, I.E. IN EACH GROUP THE MINIMUM DISTANCE
                        #3. COMBINE NEAREST DISTANCE VALUES AND TYPE OF ROAD INTO 3 RISK GROUPS:
                            #HIGH: MAJOR ROAD, CLOSE (<50KM)
                            #MED: MAJOR ROAD, FAR (>50KM) OR MINOR ROAD, CLOSE(<50KM)
                            #LOW: MINOR ROAD, FAR (>50KM)OR MAJOR ROAD, V FAR (>100KM)
                            #VERY LOW: MINOR ROAD, V FAR (>100KM)
